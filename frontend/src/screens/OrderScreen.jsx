...
import { useGetOrderDetailsQuery,usePayOrderMutation,useGetPayPalClientIdQuery,useDelieverOrderMutation, } from '../slices/ordersApiSlice';
...
const OrderScreen = () => {
    ...
    const [deliverOrder,{isLoading:loadingDeliver}] =useDelieverOrderMutation();
